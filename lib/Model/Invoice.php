 ...
 *
 * @category Class
 * @description Represents a generated invoice for an order.
 * @package  Solifyn
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Invoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets url
     *
     * @param string $url Invoice URL for downloading or viewing PDF.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Invoice creation date.
     *
     * @return self
     */
