 ...
 */
class BrandCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BrandCreate';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BrandCreate., must be smaller than or equal to 100.');
        }
     ...
     *
     * @param string|null $statement_descriptor Credit card statement descriptor (Max 22 chars)
     *
     * @return self
     */
    public function setStatementDescriptor($statement_descriptor)
    {
        ...
        if ((mb_strlen($statement_descriptor) > 22)) {
            throw new \InvalidArgumentException('invalid length for $statement_descriptor when calling BrandCreate., must be smaller than or equal to 22.');
        }
