 ...
 */
class UpdateEntitlementDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateEntitlementDto';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The user-friendly name of the entitlement
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of access to grant
     *
     * @return self
     */
