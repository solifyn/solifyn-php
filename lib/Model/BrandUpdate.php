 ...
 */
class BrandUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BrandUpdate';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Name of the brand
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BrandUpdate., must be smaller than or equal to 100.');
        }
