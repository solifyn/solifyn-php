...
/**
 * CreateCollectionCheckoutDto Class Doc Comment
 *
 * @category Class
 * @package  Solifyn
 * @author   OpenAPI Generator team
 ...
 */
class CreateCollectionCheckoutDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCollectionCheckoutDto';
    ...
    */
     ...
     * Sets collection_id
     *
     * @param string $collection_id The database ID of the collection to checkout
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param float|null $quantity Quantity of collections to buy
     *
     * @return self
     */
     ...
     * Sets aff
     *
     * @param string|null $aff Affiliate tracking code
     *
     * @return self
     */
     ...
     * Sets custom_fields
     *
     * @param object|null $custom_fields Custom text fields / selected addons
     *
     * @return self
     */
