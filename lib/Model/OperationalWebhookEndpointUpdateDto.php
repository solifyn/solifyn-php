...
/**
 * OperationalWebhookEndpointUpdateDto Class Doc Comment
 *
 * @category Class
 * @package  Solifyn
 * @author   OpenAPI Generator team
 ...
 */
class OperationalWebhookEndpointUpdateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OperationalWebhookEndpointUpdateDto';
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 65536)) {
            throw new \InvalidArgumentException('invalid length for $url when calling OperationalWebhookEndpointUpdateDto., must be smaller than or equal to 65536.');
        }
     ...
     * Sets throttle_rate
     *
     * @param float|null $throttle_rate Maximum messages per second to send to this endpoint.
     *
     * @return self
     */
