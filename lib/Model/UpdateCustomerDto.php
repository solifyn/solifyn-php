...
class UpdateCustomerDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The customer friendly full name
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateCustomerDto., must be smaller than or equal to 100.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling UpdateCustomerDto., must be smaller than or equal to 30.');
        }
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) > 100)) {
            throw new \InvalidArgumentException('invalid length for $username when calling UpdateCustomerDto., must be smaller than or equal to 100.');
        }
