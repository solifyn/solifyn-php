...
/**
 * LicensesActivateRequest Class Doc Comment
 *
 * @category Class
 * @package  Solifyn
 * @author   OpenAPI Generator team
 ...
 */
class LicensesActivateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'licenses_activate_request';
    ...
    */
     ...
     *
     * @param string $device_identifier Unique identifier of the device/machine being activated.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name A user-friendly label/name for the instance.
     *
     * @return self
     */
