...
/**
 * UpdateInstanceDto Class Doc Comment
 *
 * @category Class
 * @package  Solifyn
 * @author   OpenAPI Generator team
 ...
 */
class UpdateInstanceDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateInstanceDto';
    ...
    */
     ...
     * Sets instance_name
     *
     * @param string|null $instance_name The updated friendly name of the instance
     *
     * @return self
     */
     ...
     * Sets ip_address
     *
     * @param string|null $ip_address The updated IP address of the client device
     *
     * @return self
     */
