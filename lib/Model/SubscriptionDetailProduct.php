...
/**
 * SubscriptionDetailProduct Class Doc Comment
 *
 * @category Class
 * @package  Solifyn
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionDetailProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionDetailProduct';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The product unique ID
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param object|null $metadata Metadata JSON payload
     *
     * @return self
     */
     ...
     * Sets pricing_type
     *
     * @param string $pricing_type Pricing type, e.g. one-time or renewal
     *
     * @return self
     */
