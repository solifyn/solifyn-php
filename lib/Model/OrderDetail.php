...
class OrderDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets files_snapshot
     *
     * @param string[]|null $files_snapshot Snapshot of files accessible after payment.
     *
     * @return self
     */
     ...
     * Sets license_key
     *
     * @param string|null $license_key Assigned license key, if applicable.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Order resolution status.
     *
     * @return self
     */
