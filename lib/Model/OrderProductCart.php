...
/**
 * OrderProductCart Class Doc Comment
 *
 * @category Class
 * @package  Solifyn
 * @author   OpenAPI Generator team
 ...
 */
class OrderProductCart implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderProductCart';
    ...
    */
     ...
     * Sets price
     *
     * @param int $price Price per item in cents.
     *
     * @return self
     */
     ...
     * Sets pricing_type
     *
     * @param string|null $pricing_type Pricing type, e.g. one-time or renewal.
     *
     * @return self
     */
