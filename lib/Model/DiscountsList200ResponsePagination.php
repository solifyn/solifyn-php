...
/**
 * DiscountsList200ResponsePagination Class Doc Comment
 *
 * @category Class
 * @package  Solifyn
 * @author   OpenAPI Generator team
 ...
 */
class DiscountsList200ResponsePagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'discounts_list_200_response_pagination';
    ...
    */
     ...
     * Sets max_page
     *
     * @param int $max_page Maximum page index available based on current page size.
     *
     * @return self
     */
