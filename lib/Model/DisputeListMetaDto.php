...
/**
 * DisputeListMetaDto Class Doc Comment
 *
 * @category Class
 * @package  Solifyn
 * @author   OpenAPI Generator team
 ...
 */
class DisputeListMetaDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DisputeListMetaDto';
    ...
    */
     ...
     * Sets total
     *
     * @param float $total Total count of disputes
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param float $limit Limit of items per page
     *
     * @return self
     */
