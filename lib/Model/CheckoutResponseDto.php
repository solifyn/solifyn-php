...
/**
 * CheckoutResponseDto Class Doc Comment
 *
 * @category Class
 * @package  Solifyn
 * @author   OpenAPI Generator team
 ...
 */
class CheckoutResponseDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckoutResponseDto';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id The unique identifier for the checkout session in database
     *
     * @return self
     */
     ...
     * Sets session_id
     *
     * @param string $session_id The unique session ID format for external clients
     *
     * @return self
     */
     ...
     * Sets checkout_url
     *
     * @param string $checkout_url The public redirect URL to the custom payment steps page
     *
     * @return self
     */
