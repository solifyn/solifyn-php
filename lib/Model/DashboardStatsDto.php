...
/**
 * DashboardStatsDto Class Doc Comment
 *
 * @category Class
 * @package  Solifyn
 * @author   OpenAPI Generator team
 ...
 */
class DashboardStatsDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DashboardStatsDto';
    ...
    protected static $setters = [
        ...
        'active_memberships' => 'setActiveMemberships'
    ];
    ...
    protected static $getters = [
        ...
        'active_memberships' => 'getActiveMemberships'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('active_memberships', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['active_memberships'] === null) {
            $invalidProperties[] = "'active_memberships' can't be null";
        }
     ...
     * Sets revenue
     *
     * @param float $revenue Gross revenue in cents
     *
     * @return self
     */
     ...
     * Sets orders_count
     *
     * @param float $orders_count Total payments processed count
     *
     * @return self
     */
     ...
     * Sets refunds_count
     *
     * @param float $refunds_count Gross amount refunded in cents
     *
     * @return self
     */
    ...
    /**
     * Gets active_memberships
     *
     * @return float
     */
    public function getActiveMemberships()
    {
        return $this->container['active_memberships'];
    }

    /**
     * Sets active_memberships
     *
     * @param float $active_memberships Number of active paying customers/memberships
     *
     * @return self
     */
    public function setActiveMemberships($active_memberships)
    {
        if (is_null($active_memberships)) {
            throw new \InvalidArgumentException('non-nullable active_memberships cannot be null');
        }
        $this->container['active_memberships'] = $active_memberships;
