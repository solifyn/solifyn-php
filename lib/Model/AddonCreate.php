 ...
 */
class AddonCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddonCreate';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_seat_addon', $data ?? [], false);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_seat_addon'] === null) {
            $invalidProperties[] = "'is_seat_addon' can't be null";
        }
     ...
     * Sets product_id
     *
     * @param string $product_id The product ID of the addon product.
     *
     * @return self
     */
     ...
     * Sets min_quantity
     *
     * @param float $min_quantity Minimum quantity of the addon allowed to be purchased.
     *
     * @return self
     */
     ...
     * Sets is_seat_addon
     *
     * @param bool $is_seat_addon Flag indicating if this addon represents a seat/license limit increment.
     *
     * @return self
     */
