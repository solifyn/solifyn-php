...
/**
 * LicensesUpdateInstancePostRequest Class Doc Comment
 *
 * @category Class
 * @package  Solifyn
 * @author   OpenAPI Generator team
 ...
 */
class LicensesUpdateInstancePostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'licenses_updateInstancePost_request';
    ...
    */
     ...
     * Sets instance_name
     *
     * @param string|null $instance_name A new human-readable display name for this instance.
     *
     * @return self
     */
     ...
     * Sets ip_address
     *
     * @param string|null $ip_address A new IP address to record for this instance.
     *
     * @return self
     */
