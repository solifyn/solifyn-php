...
/**
 * OperationalWebhookEndpointHeadersResponseDto Class Doc Comment
 *
 * @category Class
 * @package  Solifyn
 * @author   OpenAPI Generator team
 ...
 */
class OperationalWebhookEndpointHeadersResponseDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OperationalWebhookEndpointHeadersResponseDto';
    ...
    */
     ...
     * Sets headers
     *
     * @param object $headers Key-value headers sent with the webhook.
     *
     * @return self
     */
     ...
     * Sets sensitive
     *
     * @param string[] $sensitive List of sensitive header keys (e.g. Authorization) that are masked.
     *
     * @return self
     */
